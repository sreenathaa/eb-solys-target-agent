...
typedef struct procfs_info
{
    ...
    unsigned long long   utime;          /* User running time in nsec */
    unsigned long long stime;          /* System running time in nsec */
    unsigned long long cstime;          /* System running time in nsec */


}
procfs_info;

#define SYSPAGE_ENTRY_SIZE( entry ) 0
#define SYSPAGE_ENTRY(param)  ((asinfo_entry*)malloc(sizeof(asinfo_entry)))
typedef asinfo_entry* asinfo;

#define DCMD_PROC_MAPINFO 0
#define EOK 1
#define DCMD_PROC_MAPDEBUG_BASE 1
#define DCMD_PROC_INFO 0
...
typedef struct procfs_debuginfo
{
    char path[NAME_MAX];
}
procfs_debuginfo;
